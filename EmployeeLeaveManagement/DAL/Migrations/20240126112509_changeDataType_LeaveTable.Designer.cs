...
namespace DAL.Migrations
{
    ...
    [Migration("20240126112509_changeDataType_LeaveTable")]
    partial class changeDataType_LeaveTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainEntity.Models.Leave", b =>
                {
                    ...
                    b.Property<float>("NumberOfLeaves")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("DomainEntity.Models.Salary", b =>
                {
                    ...
                    b.Property<decimal>("GeneralDeduction")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("TotalDedection")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DomainEntity.Models.LeaveHistory", b =>
                {
                    b.HasOne("DomainEntity.Models.Leave", "Leave")
            ...
            modelBuilder.Entity("DomainEntity.Models.LoanInstallmentHistory", b =>
                {
                    b.HasOne("DomainEntity.Models.Loan", "Loan")
                        .WithMany("LoanInstallmentHistories")
            ...
            modelBuilder.Entity("DomainEntity.Models.Salary", b =>
                {
                    b.HasOne("DomainEntity.Models.Employee", "Employee")
                        .WithOne("Salary")
                        .HasForeignKey("DomainEntity.Models.Salary", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DomainEntity.Models.SalaryHistory", b =>
                {
                    ...
                    b.HasOne("DomainEntity.Models.Salary", null)
                        .WithMany("SalaryHistories")
            ...
            modelBuilder.Entity("DomainEntity.Models.Loan", b =>
                {
                    b.Navigation("LoanInstallmentHistories");
                });
